        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80">
              ...
              <li><Link to="/how-it-works" className="hover:text-fresh transition-colors">How It Works</Link></li>
              ...
              {/* Note: I kept the links from the second block as they map to your defined routes */}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-white/80">
              {/* Keeping plain <a> tags for external/non-routed content like help/legal */}
